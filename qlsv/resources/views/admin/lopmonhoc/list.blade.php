            ...
            <div class="row mb-3">
                ...
                <div class="col-auto ml-auto">
                    <div class="row mb-3">
                        {{-- Thêm bản ghi --}}
                        <div class="col-auto">
                            <a href="/admin/lopmonhoc/add" class="btn btn-success">
                        ...
                        <div class="col-auto">
                            ...
                            <button class="btn btn-danger" onclick="beforeDeletes('/admin/lopmonhoc/deletemany')">
            ...
            <table class="table table-bordered table-hover" id="table-sort">
                <thead>
                    <tr>
                        ...
                        <th scope="col" onclick="sortTable(3,'table-sort')"><a href="#">Mã lớp<i
                                    class="fa fa-fw fa-sort"></i></a></th>
                        <th scope="col" onclick="sortTable(4,'table-sort')"><a href="#">Tên lớp<i
                                    class="fa fa-fw fa-sort"></i></a></th>
                        <th>Thao tác</th>
                    </tr>
                </thead>
                ...
                <tbody>
                    @if ($lopmonhocs->count())
                        @foreach ($lopmonhocs as $index => $lop)
                            <tr>
                                <td><input type="checkbox" class="checkbox"></td>
                                <td>{{ $lopmonhocs->firstItem() + $index }}</td>
                                <td hidden>{{ $lop->id }}</td>
                                <td>{{ $lop->malop }}</td>
                                <td>{{ $lop->tenlop }}</td>
                                <td>
                                    <a class="btn btn-primary btn-sm" href="/admin/lopmonhoc/edit/{{ $lop->id }}">
                                        <i class="fas fa-edit"> </i>
                                    </a>
                                    <a href="#" class="btn btn-danger btn-sm"
                                        onclick="removeRow({{ $lop->id }},'/admin/lopmonhoc/delete')">
                    ...
                    @else
                        <tr>
                            <td colspan="6">Không có lớp môn học nào.</td>
                        </tr>
                    @endif
                </tbody>
            </table>
            {{-- {{ $lopmonhocs->links() }} --}}
            {{ $lopmonhocs->appends(['perPage' => request()->query('perPage')])->links() }}
        </div>
    </div>
@endsection
